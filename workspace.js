...
cprequire_test(["inline:net-fka-ck-ws"], function(ws) {
...
cpdefine("inline:net-fka-ck-ws", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-fka-ck-ws", // Make the id the same as the cpdefine id
        name: "Workspace / CableKam", // The descriptive name of your widget.
        desc: `A CableKam UI`,
